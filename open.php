...
require(CLIENTINC_DIR.'mofet-header.php');
if ($ticket
    && (
    ...
    echo '<div class="col sm 12" style="    background-color: #349b40;
    color: #fff;
    padding: 5px;
    margin-bottom: 5px;
    font-weight: normal;">'._('פנייתך נשלחה בהצלחה').'</div>';
    ...
    require(CLIENTINC_DIR.'templates/mofet-form.php');
}
//require(CLIENTINC_DIR.'footer.inc.php');
require(CLIENTINC_DIR.'mofet-footer.php');
?>
